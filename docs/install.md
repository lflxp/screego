...
Download the zip with the binary for your platform from [screego/server Releases](https://github.com/lflxp/screego/releases).

```bash
$ wget https://github.com/lflxp/screego/releases/download/vGITHUB_VERSION/screego_GITHUB_VERSION_{PLATFORM}.tar.gz
```
